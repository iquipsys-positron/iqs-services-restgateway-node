...
class RestGatewayCommandSet extends pip_services_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeUpdateStatusCommand() {
        return new pip_services_commons_node_2.Command("update_status", new pip_services_commons_node_3.ObjectSchema(true)
